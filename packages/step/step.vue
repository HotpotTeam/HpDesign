<template>
  <div class="xxx-step" :style="stepStyle" :class="`step-${direction}`">
    <div class="step-head">
      <div class="line" :style="lineStyle"></div>
      <div class="ico" :style="icoWrapperStyle">
        <template v-if="icon">
          <xxx-icon  :name="icon" :style="icoStyle" ></xxx-icon>
        </template>
        <template v-else>
          <xxx-icon v-if="index<=active" name="success" :style="icoStyle"></xxx-icon>
